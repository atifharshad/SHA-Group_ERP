...
import AIRegistration from "../../../DataqueueSystems/AIRegistration/AIRegistration";
...
const Content = ({ sidebarIsOpen, toggleSidebar }) => (
  ...
  >
    ...
    <Switch>
      <Route path="/projects/DataqueueSystems/" exact component={DataqueueSystems} />
      <Route path="/projects/dataqueueSystems/client_projects" exact component={AIList} />  
      <Route path="/projects/dataqueueSystems/client_projects/:id" exact component={AIDetailView} />    
      <Route path="/projects/dataqueueSystems/airegister" exact component={AIRegistration} />
      <Redirect to={`/projects/DataqueueSystems/`} />
