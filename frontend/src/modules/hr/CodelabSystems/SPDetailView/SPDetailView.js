              ...
              <Form onSubmit={formik.handleSubmit}>
                ...
                <Row>
                  <Col>
                    <FormGroup>
                      <label>Project</label>
                      <Input type="select" disabled {...formik.getFieldProps("project")}>
                ...
                <Row>
                  ...
                  <FormGroup>
                      <label>School</label>
                      <Input type="select" disabled {...formik.getFieldProps("sslc")}>
                        {schools.map((school) => (
                          // detail.workshop === workshop.id ? (
                          //   <option selected value={workshop.id}>
                          //     {workshop.date_of_workshop} | {workshop.name} |{" "}
                ...
                <Row>
                  ...
                  <FormGroup>
                      <label>College</label>
                      <Input type="select" disabled {...formik.getFieldProps("puc")}>
                ...
                <Row>
                  ...
                  <FormGroup>
                      <label>College</label>
                      <Input type="select" disabled {...formik.getFieldProps("degree")}>
