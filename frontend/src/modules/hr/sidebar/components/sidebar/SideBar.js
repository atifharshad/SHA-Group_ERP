...
const SideBar = ({ isOpen, toggle }) => {
  ...
  const [DataqueCollapsed, setDataqueCollapsed] = useState(true);
  const [SU, setSU] = useState(false);
  React.useEffect(()=>{
    setSU(localStorage.getItem("su"))
   }, [SU])
  const toggleMenu = (menu) => {
    switch (menu){
      ...
      break;
      case dataque: setDataqueCollapsed(!DataqueCollapsed);
      break;
      default:
    }
  ...
  <div className={classNames("sidebar", { "is-open": isOpen })}>
    <div className="sidebar-header">
      ...
      { SU ? (<a href="/" style={{color: 'white', textDecoration: 'none' }}>
    ...
    <div className="side-menu">
      <Nav vertical className="list-unstyled pb-3">
        ...
        <NavItem>
            <NavLink tag={Link} to={`/projects/dataqueueSystems/`}>
      ...
      >
        {/* 3rd level menu */}
              ...
              className="pl-4"
              >
          <NavLink tag={Link} to={"/hr/cognitiveSolutions/academic_internship"}>
        ...
        className="pl-4"
        >
        <NavLink tag={Link} to={"/hr/cognitiveSolutions/cognitive_internship"}>
            {/* <FontAwesomeIcon icon={faQuestion}  /> */}
        ...
        className="pl-4"
        >
        <NavLink tag={Link} to={"/hr/cognitiveSolutions/employee_internship"}>
            {/* <FontAwesomeIcon icon={faQuestion}  /> */}
            Employee Internship
          </NavLink>
        </NavItem>
      ...
      >
        {/* 3rd level menu */}
              ...
              className="pl-4"
              >
          <NavLink tag={Link} to={"/hr/cognitiveSolutions/academic_workshop"}>
            {/* <FontAwesomeIcon icon={faQuestion}  /> */}
            Academic Workshop
          </NavLink>
        </NavItem>
        ...
        className="pl-4"
        >
        <NavLink tag={Link} to={"/hr/cognitiveSolutions/cognitive_workshop"}>
            {/* <FontAwesomeIcon icon={faQuestion}  /> */}
            Cognitive Workshop 
          </NavLink>
        </NavItem>
      ...
      >
        {/*change the url of student project */}
          <NavLink tag={Link} to={"/hr/codelabSystems/collegeWiseList"}>
        ...
        <div>
          {/* 1st level menu */}
      <NavItem
        onClick={() => toggleMenu(dataque)}
        className={classNames({ "menu-open": !DataqueCollapsed})}
        className = {"pl-0"}
      >
        <NavLink className="dropdown-toggle">
          <FontAwesomeIcon icon={faLandmark}  />
      ...
      <Collapse
        isOpen={!DataqueCollapsed}
        
        className={classNames("items-menu", { "mb-1": !DataqueCollapsed})}
      >
      {/* <NavItem
      className = {"pl-2"}
      >
      ...
      >
        {/*change the url of student project */}
          <NavLink tag={Link} to={"/hr/DataqueueSystems/client_projects"}>
            <FontAwesomeIcon icon={faUsers}/>
           Client Project 
          </NavLink>
        </NavItem>  
