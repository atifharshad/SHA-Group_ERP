                      ...
                      return (
                        ...
                        listItem.students.map((listSubItem, index) => {
                          ...
                          <td
                           className='hvr'
                           onClick={() => {
                            history.push(`/administration/codelabSystems/sp_detail/${listSubItem.id}`);
                          }}>
                          {listSubItem.register_no}</td>
                          <td className='hvr'>{listSubItem.name}</td>
                          <td className='hvr'>{listSubItem.contact_1}</td>
                          <td className='hvr'>{listSubItem.contact_2 ? listSubItem.contact_2 : '-'}</td>
