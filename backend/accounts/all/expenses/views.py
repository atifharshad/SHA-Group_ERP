...
class StatementView(views.APIView):
    ...
    def get(self, request, format=None):
        ...
        for ei_fees in ei_fees_list:
            ...
            statement = {"date": ei_fees.date, "account_head": "Employee Internship Fees","description": ei_fees.receipt_no + "-" + ei_fees.received_from.name if ei_fees.received_from else "unknown"  , "debit":ei_fees.amount, "credit":None}
            statements.append(statement)
